...
[assembly: ExportRenderer(typeof(CustomizedFrame), typeof(DroidCustomizedFrame))]
namespace Raise.Droid.CustomDroid
{
    public class DroidCustomizedFrame : FrameRenderer
    {
        public DroidCustomizedFrame(Context context) : base(context)
        {
        }
