...
[assembly: ExportRenderer(typeof(RoundedEditor), typeof(DroidRoundedEditor))]
namespace Raise.Droid.CustomDroid
{
    public class DroidRoundedEditor : EditorRenderer
    {
        public RoundedEditor _Element => Element as RoundedEditor;
        public DroidRoundedEditor(Context context) : base(context)
        {
        }
